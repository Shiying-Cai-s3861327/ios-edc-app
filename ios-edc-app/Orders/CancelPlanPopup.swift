//
//  CancelPlanPopup.swift
//  ios-edc-app
//  Cancel Plan Popup View
//  Created by Shiying Cai on 2022/11/4.
//

import SwiftUI

struct CancelPlanPopup: View {
    ...
    var body: some View {
        VStack(spacing: 40){
            HStack{
                Text("Are you sure you’d like to cancel this plan?")
...
struct CancelPlanPopup_Previews: PreviewProvider {
    struct CancelPlanPopupHolder: View {
    @State var isShowed = false
    @State var isCanceled = false

    var body: some View {
        CancelPlanPopup(isShowed: $isShowed, isCanceled: $isCanceled)
        }
    }
    static var previews: some View {
        CancelPlanPopupHolder()
    }
}
