        ...
        ZStack{
            ...
            VStack{
                ...
                VStack(spacing: -10){
                    ...
                    NavigationLink("", destination:  OrderCalculateView(), isActive: $showCalculateView)
                        .navigationBarTitleDisplayMode(.inline)
                        .navigationTitle("")
                    
                    NavigationLink(destination: OrderCalculateView()){
                        Text("Skip This Step")
                            .font(.custom("SF Pro Medium", size: 16))
                            .underline()
